...
- ⚠️ Panel admin del gateway = **https://victoria.local/admin** (nginx TLS 443 en victoria → gateway loopback; cert mkcert de kalimete, CA confiable en kalimete). Vía túnel /admin da 403 (middleware CF-Connecting-IP, parche 2026-08-13). El 8010 quedó loopback-only (2026-08-14): nginx 443 y cloudflared (túnel) lo usan por 127.0.0.1. UIs de ComfyUI (:8188) y NemoClaw/OpenClaw (:18789) = **SOLO victoria.local** — NUNCA exponer por túnel/dominio.
